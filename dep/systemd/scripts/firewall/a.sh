...
host() {
    ...
    ssh() {
        # Filter Rules
        nft add rule inet firelux input ip saddr 192.168.10.0 iif "gw266884" tcp dport 444 accept
        nft add rule inet firelux output ip daddr 192.168.10.0 oif "gw266884" tcp sport 444 accept
    }
