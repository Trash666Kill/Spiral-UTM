...
journalctl -k -f | grep -E "PREROUTING|POSTROUTING"
journalctl -k -f | grep -E "INPUT_DROP|OUTPUT_DROP|FORWARD_DROP"
journalctl -k -f | grep -E "INPUT_DROP|OUTPUT_DROP|FORWARD_DROP|PREROUTING|POSTROUTING"